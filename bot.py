...
VERIFY_EXPIRE = 43200
IS_VERIFY = "True"
access_token = 'Teleservice_01719f766885b9fc08c7ea20af44d379e9ec953fc8875c96a155b32b8e6f73e7'
username = 'TeraboxVideoSvBot'
BOT_API_TOKEN = '7670582639:AAHmjJjEytox2Fqx-2scmavAmOi_bTbkrac'
API_ID = '25637343'
dump_id = '-1002105253581' # idhar kuch nhi dalna or hatana bhi nhi
...
async def handle_premium_user(client, message, user_mention):
    ...
    join_button = InlineKeyboardButton("🌐 Join ❤️", url="https://t.me/PvFilmsX")
    developer_button = InlineKeyboardButton("👨‍💻 Premium ⚡️", url="https://t.me/Sunil_v")
...
async def handle_non_premium_user(client, message, verify_status, user_id, user_mention):
    ...
    tutorial_button = InlineKeyboardButton("📚 How to Verify", url="https://t.me/how_to_download_SvFilmsX")
...
Pᴀʏ Vɪᴀ Uᴘɪ » **Sunil.verma060@ybl**
